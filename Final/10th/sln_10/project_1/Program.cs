...
namespace project_1
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            // 추출해서 확인하는 일 모두 가능하다.
            book.title = "떡볶이가 먹고 싶어";
            book.writer = "유산슬";
            book.contents = "떡볶이는 언제 먹어도 맛있어";
            book.publisher = "도서출판 분식집";
            book.published_date = 202405007;
            ...
            // 클래스 변수
            // 클래스 이름을 사용해서 곧바로 변수의 메서드를 사용할 수 있다
            // 클래스 변수의 클래스 메서드를 만들 때는 static 키워드를 사용한다
